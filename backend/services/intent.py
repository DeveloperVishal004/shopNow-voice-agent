...
INTENT_FUNCTIONS = [
    ...
    {
        "name": "product_query",
        "description": "Customer is asking about a product — details, availability, size, colour, compatibility",
        "parameters": {
            "type": "object",
            "properties": {
                "product_name": {
                ...
                "query_type": {
                    "type": "string",
                    "description": "What they want to know e.g. availability, size, price, compatibility"
                }
            },
            "required": []
        }
